...
REALTIME_SPEAKER_EMBEDDING_MODEL = os.getenv("REALTIME_SPEAKER_EMBEDDING_MODEL", "").strip()
REALTIME_SPEAKER_SIMILARITY_THRESHOLD = float(
    os.getenv("REALTIME_SPEAKER_SIMILARITY_THRESHOLD", "0.75")
)
REALTIME_SPEAKER_MIN_SEGMENT_SEC = float(os.getenv("REALTIME_SPEAKER_MIN_SEGMENT_SEC", "0.5"))
REALTIME_SPEAKER_MAX_SPEAKERS = int(os.getenv("REALTIME_SPEAKER_MAX_SPEAKERS", "8"))
